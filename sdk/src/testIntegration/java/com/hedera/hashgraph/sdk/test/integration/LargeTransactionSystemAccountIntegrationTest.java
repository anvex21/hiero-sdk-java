...
public class LargeTransactionSystemAccountIntegrationTest {
    ...
    void nonPrivilegedAccountCannotCreateLargeFile() throws Exception {
        try (var testEnv = new IntegrationTestEnv(1)) {
            ...
            Assumptions.assumeFalse(isPrivilegedSystemAccount(testEnv.operatorId),
                "Test requires non-privileged account");
    ...
    void systemAdminAccountCanCreateLargeFile() throws Exception {
        try (var testEnv = createSystemAccountTestEnv()) {
            ...
            Assumptions.assumeTrue(testEnv.operatorId.num == 50,
                "Test requires system admin account 0.0.50");
    ...
    void treasuryAccountCanCreateLargeFile() throws Exception {
        try (var testEnv = createSystemAccountTestEnv()) {
            ...
            Assumptions.assumeTrue(testEnv.operatorId.num == 2,
                "Test requires treasury account 0.0.2");
